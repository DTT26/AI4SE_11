...
-- Script cập nhật ảnh cho 39 khoa sử dụng thư mục uploads/departments/
-- Ảnh được lưu trong backend/uploads/departments/ với tên department_{id}.jpg

-- Nhóm Nội khoa (1-9)
-- 1. Nội tổng hợp
UPDATE Departments 
SET image_url = '/uploads/departments/department_1.jpg' 
WHERE departmentid = 1;

-- 2. Tim mạch
UPDATE Departments 
SET image_url = '/uploads/departments/department_2.jpg' 
WHERE departmentid = 2;

-- 3. Hô hấp
UPDATE Departments 
SET image_url = '/uploads/departments/department_3.jpg' 
WHERE departmentid = 3;

-- 4. Tiêu hóa
UPDATE Departments 
SET image_url = '/uploads/departments/department_4.jpg' 
WHERE departmentid = 4;

-- 5. Nội thận
UPDATE Departments 
SET image_url = '/uploads/departments/department_5.jpg' 
WHERE departmentid = 5;

-- 6. Nội tiết
UPDATE Departments 
SET image_url = '/uploads/departments/department_6.jpg' 
WHERE departmentid = 6;

-- 7. Nội thần kinh
UPDATE Departments 
SET image_url = '/uploads/departments/department_7.jpg' 
WHERE departmentid = 7;

-- 8. Huyết học
UPDATE Departments 
SET image_url = '/uploads/departments/department_8.jpg' 
WHERE departmentid = 8;

-- 9. Lao & Bệnh phổi
UPDATE Departments 
SET image_url = '/uploads/departments/department_9.jpg' 
WHERE departmentid = 9;

-- Nhóm Ngoại khoa (10-16)
-- 10. Truyền nhiễm
UPDATE Departments 
SET image_url = '/uploads/departments/department_10.jpg' 
WHERE departmentid = 10;

-- 11. Ngoại tổng hợp
UPDATE Departments 
SET image_url = '/uploads/departments/department_11.jpg' 
WHERE departmentid = 11;

-- 12. Ngoại thần kinh
UPDATE Departments 
SET image_url = '/uploads/departments/department_12.jpg' 
WHERE departmentid = 12;

-- 13. Ngoại niệu
UPDATE Departments 
SET image_url = '/uploads/departments/department_13.jpg' 
WHERE departmentid = 13;

-- 14. Ngoại tiết niệu
UPDATE Departments 
SET image_url = '/uploads/departments/department_14.jpg' 
WHERE departmentid = 14;

-- 15. Chấn thương chỉnh hình
UPDATE Departments 
SET image_url = '/uploads/departments/department_15.jpg' 
WHERE departmentid = 15;

-- 16. Phẫu thuật tạo hình
UPDATE Departments 
SET image_url = '/uploads/departments/department_16.jpg' 
WHERE departmentid = 16;

-- Nhóm Cấp cứu & Chuyên khoa (17-25)
-- 17. Cấp cứu
UPDATE Departments 
SET image_url = '/uploads/departments/department_17.jpg' 
WHERE departmentid = 17;

-- 18. Da liễu
UPDATE Departments 
SET image_url = '/uploads/departments/department_18.jpg' 
WHERE departmentid = 18;

-- 19. Nhi khoa
UPDATE Departments 
SET image_url = '/uploads/departments/department_19.jpg' 
WHERE departmentid = 19;

-- 20. Sản phụ khoa
UPDATE Departments 
SET image_url = '/uploads/departments/department_20.jpg' 
WHERE departmentid = 20;

-- 21. Tai Mũi Họng
UPDATE Departments 
SET image_url = '/uploads/departments/department_21.jpg' 
WHERE departmentid = 21;

-- 22. Nhãn khoa
UPDATE Departments 
SET image_url = '/uploads/departments/department_22.jpg' 
WHERE departmentid = 22;

-- 23. Răng Hàm Mặt
UPDATE Departments 
SET image_url = '/uploads/departments/department_23.jpg' 
WHERE departmentid = 23;

-- 24. Lão khoa
UPDATE Departments 
SET image_url = '/uploads/departments/department_24.jpg' 
WHERE departmentid = 24;

-- 25. Nam khoa
UPDATE Departments 
SET image_url = '/uploads/departments/department_25.jpg' 
WHERE departmentid = 25;

-- Nhóm Chuyên khoa sâu (26-30)
-- 26. Vô sinh - Hiếm muộn
UPDATE Departments 
SET image_url = '/uploads/departments/department_26.jpg' 
WHERE departmentid = 26;

-- 27. Cơ xương khớp
UPDATE Departments 
SET image_url = '/uploads/departments/department_27.jpg' 
WHERE departmentid = 27;

-- 28. Chẩn đoán hình ảnh
UPDATE Departments 
SET image_url = '/uploads/departments/department_28.jpg' 
WHERE departmentid = 28;

-- 29. Xét nghiệm
UPDATE Departments 
SET image_url = '/uploads/departments/department_29.jpg' 
WHERE departmentid = 29;

-- 30. Gây mê hồi sức
UPDATE Departments 
SET image_url = '/uploads/departments/department_30.jpg' 
WHERE departmentid = 30;

-- Nhóm Hỗ trợ điều trị (31-35)
-- 31. Phục hồi chức năng - Vật lý trị liệu
UPDATE Departments 
SET image_url = '/uploads/departments/department_31.jpg' 
WHERE departmentid = 31;

-- 32. Dinh dưỡng
UPDATE Departments 
SET image_url = '/uploads/departments/department_32.jpg' 
WHERE departmentid = 32;

-- 33. Tâm lý
UPDATE Departments 
SET image_url = '/uploads/departments/department_33.jpg' 
WHERE departmentid = 33;

-- 34. Tâm thần
UPDATE Departments 
SET image_url = '/uploads/departments/department_34.jpg' 
WHERE departmentid = 34;

-- 35. Ung bướu
UPDATE Departments 
SET image_url = '/uploads/departments/department_35.jpg' 
WHERE departmentid = 35;

-- Nhóm Y học & Đa khoa (36-39)
-- 36. Y học cổ truyền
UPDATE Departments 
SET image_url = '/uploads/departments/department_36.jpg' 
WHERE departmentid = 36;

-- 37. Y học dự phòng
UPDATE Departments 
SET image_url = '/uploads/departments/department_37.jpg' 
WHERE departmentid = 37;

-- 38. Đa khoa
UPDATE Departments 
SET image_url = '/uploads/departments/department_38.jpg' 
WHERE departmentid = 38;

-- 39. Ngôn ngữ trị liệu
UPDATE Departments 
SET image_url = '/uploads/departments/department_39.jpg' 
WHERE departmentid = 39;

-- Kiểm tra kết quả
SELECT departmentid, department_name, image_url 
FROM Departments 
